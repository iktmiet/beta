...
function loadContent() {
    fetch('../beta/content/information.json')
...
function saveContent(content) {
    fetch('../beta/content/save_information.php', {
        method: 'POST',
        headers: {
...
const newContent = {
    ...
    mainText: {
        text: 'Новый основной текст',
        style: 'font-size: 18px;',
    },
    importantInfo: {
        text: 'Новая важная информация',
        style: 'font-size: 16px; color: red;',
    },
    mainText2: {
        text: 'Еще один новый основной текст',
        style: 'font-size: 18px;',
    },
};
